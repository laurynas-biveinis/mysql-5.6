...
FUNCTION(FIND_SYSTEM_LZ4)
  ...
  IF (LZ4_INCLUDE_DIR AND LZ4_SYSTEM_LIBRARY)
    ...
    SET(lz4_SYSTEM_LINK_FLAGS "-llz4" CACHE STRING "Link flag for lz4")
  ENDIF()
...
MACRO (MYSQL_CHECK_LZ4)
  ...
  ELSEIF(WITH_LZ4 STREQUAL "3rdparty")
    ...
    ADD_LIBRARY(lz4_interface INTERFACE)
    TARGET_LINK_LIBRARIES(lz4_interface INTERFACE ${LZ4_LIBRARY})
    FIND_LZ4_VERSION(${LZ4_INCLUDE_DIR})
    # For EXTRACT_LINK_LIBRARIES
    SET(lz4_SYSTEM_LINK_FLAGS "-lz4" CACHE STRING "Link flag for lz4")
  ELSE()
