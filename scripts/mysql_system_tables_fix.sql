...
ALTER TABLE proxies_priv MODIFY Host char(255) CHARACTER SET ASCII DEFAULT '' NOT NULL, ENGINE=ROCKSDB;
...
-- tables_priv, user.
ALTER TABLE func ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE help_topic ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE help_category ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE help_relation ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE help_keyword ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE plugin ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE servers ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE time_zone ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE time_zone_leap_second ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE time_zone_name ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE time_zone_transition ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE time_zone_transition_type ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE db ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE user ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE tables_priv ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE columns_priv ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE procs_priv ENGINE=ROCKSDB STATS_PERSISTENT=0;
ALTER TABLE proxies_priv ENGINE=ROCKSDB STATS_PERSISTENT=0;
